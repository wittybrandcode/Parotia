...
const t: Record<Lang, Record<TK, string>> = {
  en: {
    ...
    heroHowDesc: "Click the Parotia icon on any page. The toolbar freezes the page and lets you pick elements to delete or hide. Save your cleanup as a preset and it will auto-apply next time you visit.",
  ...
  ar: {
    ...
    heroHow: "كيف يعمل",
    heroHowDesc: "اضغط على أيقونة Parotia في أي صفحة. يجمّد الشريط الصفحة ويتيح لك تحديد العناصر للحذف أو الإخفاء. احفظ التنظيف كقالب وسيتم تطبيقه تلقائياً في المرة القادمة.",
