...
const t: Record<Lang, Record<TranslationKeys, string>> = {
  en: {
    heroTitle: "Parotia",
    heroSub: "Clean the stage. Keep the story.",
    heroDesc:
      "Parotia is a Chrome extension that declutters news articles, blog posts, and any web page — removing ads, navigation bars, sidebars, and distractions so you can focus on what matters.",
    heroHow: "How it works",
    heroHowDesc:
      "Click the Parotia icon on any page. The toolbar freezes the page and lets you pick elements to delete, hide, or protect. Save your cleanup as a preset and it will auto-apply next time you visit.",
    ...
    kbFreeze: "Shift + Alt + F",
    kbFreezeD: "Toggle Freeze / Unfreeze",
    kbPick: "Shift + Alt + P",
    kbPickD: "Toggle element picker",
    kbDel: "Delete",
    kbDelD: "Delete the selected element (while picking)",
    kbEsc: "Escape",
    kbEscD: "Cancel picking / close inspector",
  ...
  ar: {
    ...
    heroDesc:
      "Parotia هو إضافة لجوجل كروم تنظف المقالات الإخبارية وصفحات الويب — بإزالة الإعلانات وأشرطة التنقل والأعمدة الجانبية والمشتتات حتى تركز على ما يهمك.",
    heroHow: "كيف يعمل",
    heroHowDesc:
      "اضغط على أيقونة Parotia في أي صفحة. يجمّد الشريط الصفحة ويتيح لك تحديد العناصر للحذف أو الإخفاء أو الحماية. احفظ التنظيف كقالب وسيتم تطبيقه تلقائياً في المرة القادمة.",
    ...
    kbFreeze: "Shift + Alt + F",
    kbFreezeD: "تبديل التجميد / إلغاء التجميد",
    kbPick: "Shift + Alt + P",
    kbPickD: "تبديل أداة تحديد العناصر",
    kbDel: "Delete",
    kbDelD: "حذف العنصر المحدد (أثناء التحديد)",
    kbEsc: "Escape",
    kbEscD: "إلغاء التحديد / إغلاق المفتاح",
...
export function OptionsApp() {
  ...
  const refresh = useCallback(async () => {
    try {
      ...
      setMessage({ ok: false, text: "Failed to load presets." });
    }
  }, []);
