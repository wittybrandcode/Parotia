...
export function applyEditorLayerStyle(layer: EditorLayer, style: EditorLayerStyle): EditorLayer {
  ...
  if (layer.kind === "text") return {
    ...
    direction: style.direction ?? layer.direction, align: style.align ?? layer.align,
    verticalAlign: style.verticalAlign ?? layer.verticalAlign, fill: style.textColor ?? layer.fill,
