...
- **الوضع الحالي للبوابة:** `typecheck` + `lint` + `test` (208/208) + `build` — كلها خضراء.
- **حالة Keep:** أُزيلت بالكامل من جميع الملفات (النوع، المحرّك، الواجهة، الاختبارات) في أغسطس 2026.
