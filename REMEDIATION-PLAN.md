...
|---|---|---|---|---|
| 0 | التأسيس — نقطة استعادة | أول commit + تنظيم ملفات القرار | 🔴 | `[0/1] ░░░░░░░░░░` |
...
|---|---|---|---|---|
| 0.1 | أول commit للمشروع (يتطلب موافقة صريحة) | 🔴 | كل الملفات عدا `dist/` و`node_modules/` | `git log` يظهر commit أول نظيف |
